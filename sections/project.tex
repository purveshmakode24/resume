...
%         \vspace{1mm}
%         \justifying{
%             \item {A Desktop App which monitors your computer system and gives you all related computer hardware info.}
%             \item {App uses frameworks like \textbf{Electron} and \textbf{Materialize}. Implemented using Node.js.}
%       }        
%     \end{cvitems}
%   } 
